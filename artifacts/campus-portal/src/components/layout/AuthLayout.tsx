  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-background flex flex-col">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute -top-40 -left-32 w-[30rem] h-[30rem] rounded-full bg-primary/15 blur-3xl animate-blob" />
        <div className="absolute -bottom-40 -right-32 w-[28rem] h-[28rem] rounded-full bg-accent/40 blur-3xl animate-blob animation-delay-2000" />
      ...
      <main className="flex-1 flex">
        ...
        <aside className="hidden lg:flex w-[28rem] xl:w-[32rem] relative bg-gradient-to-br from-primary via-primary to-primary/85 text-primary-foreground p-12 flex-col justify-between overflow-hidden">
          ...
          <div className="relative text-xs text-primary-foreground/60 border-t border-white/10 pt-4">
